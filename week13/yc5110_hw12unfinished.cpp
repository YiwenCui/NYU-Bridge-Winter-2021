...
int main()
{
    ...
    // cout << "The list of cahsed checks in order:" << endl;
    // for (int i = 0; i < allCashedChecksNum.size(); i++)
    // {
    //     if (i == 0)
    //     {
    //         cout << "[" << allCashedChecksNum[i] << ", ";
    //     }
    //     else if (i == allCashedChecksNum.size() - 1)
    //     {
    //         cout << allCashedChecksNum[i] << ", ";
    //     }
    ...
    // cout << "The list of non cahsed checks in order:" << endl;
    // for (int i = 0; i < allNonCashedChecksNum.size(); i++)
    // {
    //     if (i == 0)
    //     {
    //         cout << "[" << allNonCashedChecksNum[i] << ", ";
    //     }
    //     else if (i == allNonCashedChecksNum.size() - 1)
    //     {
    //         cout << allNonCashedChecksNum[i] << ", ";
    //     }
    //     else
